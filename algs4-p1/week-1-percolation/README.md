...
----------------------------------
2.4K May  3 13:01 Percolation.java
2.3K May  3 13:01 PercolationStats.java
...
Test 18: call all methods in random order until all sites are open,
  ...
  * n = 20
    ...
    - student   isFull(16, 18) = true
    - reference isFull(16, 18) = false
    - failed on trial 1 of 2

  * n = 50
    - isFull() returns wrong value after 1457 sites opened
    - student   isFull(46, 7) = true
    - reference isFull(46, 7) = false
...
-----------------------------------------------------------------------------------
=> passed       16          149                   272                   1         
=> passed       32          688                  1172                   1         
=> passed       64         2471                  4456                   1         
=> passed      128        11261                 19132                   1         
=> passed      256        46618                 78122                   1         
=> passed      512       184250                310698                   1         
=> passed     1024       741947               1247010                   1         
==> 7/7 tests passed
...
Test 3: Create an n-by-n percolation system; interleave calls to percolates()
     ...
     -------------------------------------------
      1024     0.18     2.9      2724560     2.0
      1448     0.57     3.3      5443210     2.0
      2048     1.16     2.1     10828492     2.0
      2896     2.67     2.4     21817288     2.0
      4096     5.76     2.2     43389914     2.0
==> passed
...
Test 4: Create an n-by-n percolation system; interleave calls to open(),
        ...
        The test is passed if n >= 4096 in under 10 seconds.
         ...
         n  seconds   ratio   operations   ratio
     -------------------------------------------
       724     0.10     2.9      1969332     1.9
      1024     0.14     0.8      3976128     2.0
      1448     0.56     4.1      7905218     2.0
      2048     1.29     2.4     15793438     2.0
      2896     2.90     2.3     31899772     2.0
      4096     5.36     1.8     63503192     2.0
==> passed
